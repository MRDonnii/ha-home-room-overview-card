...
class HaHomeRoomOverviewCard extends HTMLElement {
  ...
  _render() {
    ...
    </div></header><div class="grid">${states.map(({ room, state }) => this._renderRoom(room, state)).join("")}</div></section>`;
